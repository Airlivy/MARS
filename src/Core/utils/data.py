...
def load_CIRR(dataset_path):
    with open(os.path.join(dataset_path, 'image_splits/split.rc2.val.json'), 'r', encoding='utf-8') as f:
        val_img_dict = json.load(f)
    with open(os.path.join(dataset_path, 'image_splits/split.rc2.test1.json'), 'r', encoding='utf-8') as f:
    ...
    val_data = json.load(open(os.path.join(dataset_path, 'captions/cap.rc2.val.json'), 'r', encoding='utf-8'))
    test_data = json.load(open(os.path.join(dataset_path, 'captions/cap.rc2.test1.json'), 'r', encoding='utf-8'))
...
def load_FashionIQ(dataset_path, category):
    ...
    with open(os.path.join(dataset_path, 'image_splits/split.{}.val.json').format(category), 'r', encoding='utf-8') as f:
    ...
    with open(os.path.join(dataset_path, 'captions/cap.{}.val.json').format(category), 'r', encoding='utf-8') as f:
...
def load_CIRCO(dataset_path):
    ...
    with open(os.path.join(dataset_path, 'captions/val.json'), 'r', encoding='utf-8') as f:
        val_data = json.load(f)
    
    with open(os.path.join(dataset_path, 'captions/test.json'), 'r', encoding='utf-8') as f:
...
def load_VisDial(dataset_path):
    with open(os.path.join(dataset_path, 'Search_Space_val_50k.json'), 'r', encoding='utf-8') as f:
    ...
    with open(os.path.join(dataset_path, 'VisDial_v1.0_queries_val.json'), 'r', encoding='utf-8') as f:
